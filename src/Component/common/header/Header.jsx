    ...
    return (
        <header>
            <div className="container header">
                <div id="logo">
                    <a href="/index.html"><img src="./images/24h_logo_trang_chu_2015.png" alt=""/></a>
                    <div className="vertical-container menu-left">
                        <ul id="menu-left" className="menu-vertical">
                            <li><a href="/lich-thi-dau-bong-da-c287.html">Trang chủ 24H</a></li>
                            <li><a className="stick-category" href="/video-ban-thang-c297.html">Tổng hợp số liệu dịch
                                COVID 19</a></li>
                            <li>
                                <a href="/bong-da/lich-thi-dau-bong-da-hom-nay-moi-nhat-c48a364371.html">Tin tức trong
                                    ngày</a>
                                <div className="vertical-container menu-child">
                                    <ul id="menu-child-0" className="menu-vertical">
                                        <li><a href="/lich-thi-dau-bong-da-c287.html">Trang chủ 24H</a></li>
                                        <li><a className="stick-category" href="/video-ban-thang-c297.html">Tổng hợp số
                                            liệu dịch COVID 19</a></li>
                                    </ul>
                                </div>
                            </li>
                ...
                <ul id="header-menu">
                    <li>
                        <a href=""><img src="./images/icons8-soccer-ball-96-copy-1541383138-270-width20height20.png"
                                        alt=""/><br/>Bóng đá</a>
                    ...
                    <li>
                        <a href=""><img src="./images/icons8-increase-96-copy-1541383138-358-width19height19.png" alt=""/><br/>Kinh
                            doanh</a>
                        <div className="vertical-container">
                            <ul id="menu-1" className="menu-vertical">
                                <li><a href="/doanh-nhan-c606.html">Doanh nhân</a></li>
                                <li><a href="/tai-chinh-c587.html">Tài chính</a></li>
                                <li><a href="/bat-dong-san-c792.html">Bất động sản</a></li>
                    ...
                    <li>
                        <a href=""><img src="./images/logo-covid-3---9slide-1628473896-250-width31height22.png" alt=""/><br/>Covid-19</a>
                    </li>
                    <li>
                        <a href=""><img src="./images/icons8-smartphone-tablet-52-copy-1541383138-560-width20height20.png"
                                        alt=""/><br/>Hi-tech</a>
                        <div className="vertical-container">
                    ...
                    <li>
                        <a href=""><img src="./images/thethao-1579244755-985-width20height22.png" alt=""/><br/>Thể thao</a>
                    </li>
                    <li>
                        <a href=""><img src="./images/nha_icon-1629109485-345-width23height23.png" alt=""/><br/>Ngoại hạng
                            Anh</a>
                    </li>
                    <li>
                        <a href=""><img src="./images/logo-t---t-1640057415-382-width37height22.png" alt=""/><br/>Xuân 2022</a>
                    </li>
                    <li>
